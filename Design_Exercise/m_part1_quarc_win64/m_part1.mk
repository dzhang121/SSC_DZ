###########################################################################
## Makefile generated for component 'm_part1'. 
## 
## Makefile     : m_part1.mk
## Generated on : Fri Feb 17 14:30:09 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\m_part1.rt-win64
...
PRODUCT_NAME              = m_part1
MAKEFILE                  = m_part1.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\ej18127\Documents\ssc
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = m_part1_comp.rsp
CMD_FILE                  = m_part1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\m_part1.rt-win64
...
DEFINES_STANDARD = -DMODEL=m_part1 -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\m_part1_quarc_win64\m_part1.c $(START_DIR)\m_part1_quarc_win64\m_part1_data.c $(START_DIR)\m_part1_quarc_win64\m_part1_main.c $(START_DIR)\m_part1_quarc_win64\rtGetInf.c $(START_DIR)\m_part1_quarc_win64\rtGetNaN.c $(START_DIR)\m_part1_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = m_part1.obj m_part1_data.obj m_part1_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\m_part1_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\m_part1_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
m_part1.obj : $(START_DIR)\m_part1_quarc_win64\m_part1.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\m_part1_quarc_win64\m_part1.c


m_part1_data.obj : $(START_DIR)\m_part1_quarc_win64\m_part1_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\m_part1_quarc_win64\m_part1_data.c


m_part1_main.obj : $(START_DIR)\m_part1_quarc_win64\m_part1_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\m_part1_quarc_win64\m_part1_main.c


rtGetInf.obj : $(START_DIR)\m_part1_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\m_part1_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\m_part1_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\m_part1_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\m_part1_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\m_part1_quarc_win64\rt_nonfinite.c
